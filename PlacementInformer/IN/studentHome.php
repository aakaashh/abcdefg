...
<div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background-color:#eeeeee;" >
                ...
                <button type="submit" name = "submit1" class="btn btn-success" action = "<?php echo htmlspecialchars('php/changePassword.php');?>" id = "submit1">Save changes</button>
            </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg" >
        ...
        <strong class="head1">Today's Company</strong>
        </h4>
	...
	//	$result = mysqli_query($con,"SELECT * FROM company where name in (select b.name from dateofvisit as d , brancheseligible as b where d.date = '$date' and b.branch = '$branch' )");
		...
		<h4 class="panel-heading">
        <strong class="head1">Upcoming Companies</strong>
        </h4>
		<?php
        ...
        while($db_field=mysqli_fetch_assoc($result))
		{
			...
			if($numRows!=0)
			{
                ...
                if($numRows1!=0)
                {
                    ...
                    echo "<div class=\"col-md-2 col-sm-6 col-lg-2 col-xs-12 each1\"> <a type=\"button\"  class=\"btn btn-success disabled\" href='# '>Registered</a></div>";
                }
                else {
                    $url = "php/applytocompany.php?cname=" . $companyName;
